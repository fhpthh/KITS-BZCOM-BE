...
public class RequestLifecycleIntegrationTest {
    ...
    @Test
    public void testCreateRequest_HighPriority_GeneratesAlertForAdmins() throws Exception {
        CreateRequestDto dto = CreateRequestDto.builder()
        ...
        assertEquals(admin.getId(), alertRepository.findAll().get(0).getTargetMemberId());
        assertEquals("HIGH_PRIORITY_REGISTERED", alertRepository.findAll().get(0).getAlertType().name());
    }
